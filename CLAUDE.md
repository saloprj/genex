...
DEXPAY_API_TOKEN, DEXPAY_SECRET_KEY  # Dexpay crypto payment processing
DEXPAY_PROJECT_NAME                  # "Default project"
DEXPAY_VAULT_ID                      # Vault ID from pay.dextrade.com/projects (268668)
DEXPAY_WEBHOOK_SECRET                # private_key from /callbacks/config/create response
